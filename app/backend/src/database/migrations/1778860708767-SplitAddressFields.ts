...
export class SplitAddressFields1778860708767 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "app_user" ADD "street" character varying(255)`,
    );
    await queryRunner.query(
      `ALTER TABLE "app_user" ADD "postal_code" character varying(10)`,
    );
    await queryRunner.query(
      `ALTER TABLE "app_user" ADD "city" character varying(100)`,
    );
  }
