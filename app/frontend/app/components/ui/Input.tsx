    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full ${Icon ? 'pl-10' : 'pl-4'} pr-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-[#00b4d8] ${error ? 'border-red-400' : 'border-gray-200'}`}
        />
      </div>
