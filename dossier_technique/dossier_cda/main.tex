...
\lstdefinelanguage{TypeScript}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, let, const, if, in, while, for, break, class, export, extends, import, from, async, await},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={boolean, number, string, void, Promise},
...
% Palette RAG
\definecolor{riskLow}{HTML}{DFF0D8}     % vert pâle
\definecolor{riskMed}{HTML}{FCF8E3}     % jaune pâle
\definecolor{riskHigh}{HTML}{F2DEDE}    % rouge pâle

% Règle de coloration par score (1–4 vert, 5–9 jaune, 10–25 rouge)
\newcommand{\riskcell}[1]{%
  \begingroup
  \def\score{#1}%
  \ifnum\score<5 \cellcolor{riskLow}\else
    \ifnum\score<10 \cellcolor{riskMed}\else
      \cellcolor{riskHigh}\fi
  \fi \textbf{#1}%
  \endgroup
}
...
% Légendes d’échelle
% Probabilité et Impact: 1 Très faible, 2 Faible, 3 Moyenne, 4 Élevé, 5 Très élevé
...
\newcommand{\ProjetTitre}{Diving O Club}
\newcommand{\CandidatNom}{Lavier Kevin}
\newcommand{\Promotion}{3ème année Programmation informatique}
\newcommand{\Entreprise}{Colint School}
\newcommand{\Tuteur}{Kwame Yamgnane}
